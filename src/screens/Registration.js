        ...
        <View style={styles.contentContainer}>
            ...
            <Controller        
                ...
                <Controller        
                    ...
                    render={({field: {onChange, value, onBlur}, fieldState: {error, isValid}}) => ( 
                    <>
                    {isValid}
                     <View style={styles.inputContainer}>
            ...
            {/* <Controller control={control} name="Againpassword"
             rules={{required: 'again password is required', minLength: {
                value: 4,
                message: 'again password should be minimum 3 characters long',
                     },}}
